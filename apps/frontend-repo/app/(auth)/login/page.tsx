...
import { Alert, Box, Container, Grid2, Snackbar, TextField, Typography } from "@mui/material";
...
export default function Login() {
  ...
  return (
    <>
      <ToggleTheme />
      <Grid2 container spacing={0} direction='column' alignItems='center' justifyContent='center' sx={{ height: "100vh" }}>
        <Container component='main' maxWidth='xs'>
          ...
          <Snackbar open={!!errorLogin} onClose={() => setErrorLogin(null)} autoHideDuration={3000} anchorOrigin={{ vertical: "bottom", horizontal: "center" }}>
            <Alert onClose={() => setErrorLogin(null)} severity='error' variant='filled' sx={{ width: "100%" }}>
              {errorLogin}
            </Alert>
          </Snackbar>
          <Snackbar open={!!successLogin} onClose={() => setSuccessLogin(null)} autoHideDuration={3000} anchorOrigin={{ vertical: "bottom", horizontal: "center" }}>
            <Alert onClose={() => setSuccessLogin(null)} severity='success' variant='filled' sx={{ width: "100%", color: "white" }}>
              {successLogin}
            </Alert>
          </Snackbar>
        </Container>
